...
Ext.define('EdiromOnline.view.window.image.ImageViewer', {
    ...
    console.log("listenForShapeLink");
    	console.log(e);
    	console.log(dom);
    	console.log(args);
